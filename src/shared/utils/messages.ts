...
const ERROR_MESSAGES: Record<string, AppMessageId> = {
  ...
  "card_batch.code_validation_failed": "error.cardBatch.codeValidationFailed",
  "card_batch.empty_selection": "error.cardBatch.emptySelection",
  "card_batch.same_pack": "error.cardBatch.samePack",
  "card_batch.target_asset_exists": "error.cardBatch.targetAssetExists",
  "card_batch.target_card_id_conflict": "error.cardBatch.targetCardIdConflict",
  "card_batch.target_pack_not_open": "error.cardBatch.targetPackNotOpen",
...
const ISSUE_MESSAGES: Record<string, AppMessageId> = {
  ...
  "card_batch.code_conflicts_with_target_pack_card": "issue.cardBatch.codeConflictsWithTargetPackCard",
  "card_batch.target_asset_exists": "issue.cardBatch.targetAssetExists",
